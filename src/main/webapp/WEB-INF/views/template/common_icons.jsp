        ...
        <!-- begin panel -->
                 <div class="panel panel-inverse" data-sortable-id="ui-icons-1">
                     ...
                     <div class="alert alert-info">
                         ...
                         <p>Increase the icon size by using the <b>fa-lg</b> (33% increase), <b>fa-2x</b>, <b>fa-3x</b>, or <b>fa-4x</b> classes.</p>
                     </div>
                         ...
                         <table class="table table-bordered">
                             <tbody>
                                 <tr>
                                     ...
                                     <td class="text-center">
                                         <div><i class="fa fa-arrow-circle-o-right fa-3x text-inverse fa-rotate-90"></i></div>
                                         <div>fa-rotate-90</div>
                                     </td>
                                     <td class="text-center">
                                         <div><i class="fa fa-arrow-circle-o-right fa-3x text-inverse fa-rotate-180"></i></div>
                                         <div>fa-rotate-180</div>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td class="text-center">
                                         <div><i class="fa fa-arrow-circle-o-right fa-3x text-inverse fa-rotate-270"></i></div>
                                         <div>fa-rotate-270</div>
                                     </td>
                                     <td class="text-center">
                                         <div><i class="fa fa-arrow-circle-o-right fa-3x text-inverse fa-flip-horizontal"></i></div>
                                         <div>fa-flip-horizontal</div>
                                     </td>
                                     <td class="text-center">
                                         <div><i class="fa fa-arrow-circle-o-right fa-3x text-inverse icon-flip-vertical"></i></div>
        ...
        <!-- begin panel -->
                 <div class="panel panel-inverse" data-sortable-id="ui-icons-6">
                     <div class="panel-heading">
                         ...
                         <h4 class="panel-title">40 New Icons in 4.2</h4>
                     </div>
                     <div class="panel-body">
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angellist"></i></div><div class="hidden-xs">fa-angellist</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-area-chart"></i></div><div class="hidden-xs">fa-area-chart</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-at"></i></div><div class="hidden-xs">fa-at</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-bell-slash"></i></div><div class="hidden-xs">fa-bell-slash</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-bell-slash-o"></i></div><div class="hidden-xs">fa-bell-slash-o</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-bicycle"></i></div><div class="hidden-xs">fa-bicycle</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-binoculars"></i></div><div class="hidden-xs">fa-binoculars</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-birthday-cake"></i></div><div class="hidden-xs">fa-birthday-cake</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-bus"></i></div><div class="hidden-xs">fa-bus</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-calculator"></i></div><div class="hidden-xs">fa-calculator</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc"></i></div><div class="hidden-xs">fa-cc</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-amex"></i></div><div class="hidden-xs">fa-cc-amex</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-discover"></i></div><div class="hidden-xs">fa-cc-discover</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-mastercard"></i></div><div class="hidden-xs">fa-cc-mastercard</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-paypal"></i></div><div class="hidden-xs">fa-cc-paypal</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-stripe"></i></div><div class="hidden-xs">fa-cc-stripe</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cc-visa"></i></div><div class="hidden-xs">fa-cc-visa</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-copyright"></i></div><div class="hidden-xs">fa-copyright</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-eyedropper"></i></div><div class="hidden-xs">fa-eyedropper</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-futbol-o"></i></div><div class="hidden-xs">fa-futbol-o</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-google-wallet"></i></div><div class="hidden-xs">fa-google-wallet</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-ils"></i></div><div class="hidden-xs">fa-ils</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-ioxhost"></i></div><div class="hidden-xs">fa-ioxhost</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-lastfm"></i></div><div class="hidden-xs">fa-lastfm</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-lastfm-square"></i></div><div class="hidden-xs">fa-lastfm-square</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-line-chart"></i></div><div class="hidden-xs">fa-line-chart</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-meanpath"></i></div><div class="hidden-xs">fa-meanpath</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-newspaper-o"></i></div><div class="hidden-xs">fa-newspaper-o</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-paint-brush"></i></div><div class="hidden-xs">fa-paint-brush</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-paypal"></i></div><div class="hidden-xs">fa-paypal</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-pie-chart"></i></div><div class="hidden-xs">fa-pie-chart</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-plug"></i></div><div class="hidden-xs">fa-plug</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-shekel"></i></div><div class="hidden-xs">fa-shekel <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-sheqel"></i></div><div class="hidden-xs">fa-sheqel <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-slideshare"></i></div><div class="hidden-xs">fa-slideshare</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-soccer-ball-o"></i></div><div class="hidden-xs">fa-soccer-ball-o <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-toggle-off"></i></div><div class="hidden-xs">fa-toggle-off</div></td>
                                     <td class="text-center"><div><i class="fa fa-toggle-on"></i></div><div class="hidden-xs">fa-toggle-on</div></td>
                                     <td class="text-center"><div><i class="fa fa-trash"></i></div><div class="hidden-xs">fa-trash</div></td>
                                     <td class="text-center"><div><i class="fa fa-tty"></i></div><div class="hidden-xs">fa-tty</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-twitch"></i></div><div class="hidden-xs">fa-twitch</div></td>
                                     <td class="text-center"><div><i class="fa fa-wifi"></i></div><div class="hidden-xs">fa-wifi</div></td>
                                     <td class="text-center"><div><i class="fa fa-yelp"></i></div><div class="hidden-xs">fa-yelp</div></td>
                                     <td></td>
                                     <td></td>
                                     <td></td>
                                     <td></td>
                     ...
                     <div class="panel-body">
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tbody>
                                     <tr>
                                         <td class="text-center"><div><i class="fa fa-2x fa-adjust"></i></div><div class="hidden-xs">fa-adjust</div></td>
                     ...
                     <div class="panel-body">
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-circle-o-notch"></i></div><div class="hidden-xs">fa-circle-o-notch</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-cog"></i></div><div class="hidden-xs">fa-cog <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-gear"></i></div><div class="hidden-xs">fa-gear</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-refresh"></i></div><div class="hidden-xs">fa-refresh</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-spinner"></i></div><div class="hidden-xs">fa-spinner</div></td>
                 ...
                 <div class="panel panel-inverse" data-sortable-id="ui-icons-12">
                     ...
                     <div class="panel-body">
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrows-alt"></i></div><div class="hidden-xs">fa-arrows-alt</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-backward"></i></div><div class="hidden-xs">fa-backward</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-compress"></i></div><div class="hidden-xs">fa-compress</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-eject"></i></div><div class="hidden-xs">fa-eject</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-expand"></i></div><div class="hidden-xs">fa-expand</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-fast-backward"></i></div><div class="hidden-xs">fa-fast-backward</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-fast-forward"></i></div><div class="hidden-xs">fa-fast-forward</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-forward"></i></div><div class="hidden-xs">fa-forward</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-pause"></i></div><div class="hidden-xs">fa-pause</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-play"></i></div><div class="hidden-xs">fa-play</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-play-circle"></i></div><div class="hidden-xs">fa-play-circle</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-play-circle-o"></i></div><div class="hidden-xs">fa-play-circle-o</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-step-backward"></i></div><div class="hidden-xs">fa-step-backward</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-step-forward"></i></div><div class="hidden-xs">fa-step-forward</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-stop"></i></div><div class="hidden-xs">fa-stop</div></td>
                         ...
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tr>
                                     ...
                                     <td class="text-center"><div><i class="fa fa-2x fa-cny"></i></div><div class="hidden-xs">fa-cny <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-dollar"></i></div><div class="hidden-xs">fa-dollar <span class="text-muted">(alias)</span></div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-eur"></i></div><div class="hidden-xs">fa-eur</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-euro"></i></div><div class="hidden-xs">fa-euro <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-gbp"></i></div><div class="hidden-xs">fa-gbp</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-inr"></i></div><div class="hidden-xs">fa-inr</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-jpy"></i></div><div class="hidden-xs">fa-jpy</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-krw"></i></div><div class="hidden-xs">fa-krw</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-money"></i></div><div class="hidden-xs">fa-money</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-rmb"></i></div><div class="hidden-xs">fa-rmb <span class="text-muted">(alias)</span></div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-rouble"></i></div><div class="hidden-xs">fa-rouble <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-rub"></i></div><div class="hidden-xs">fa-rub</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-ruble"></i></div><div class="hidden-xs">fa-ruble <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-rupee"></i></div><div class="hidden-xs">fa-rupee <span class="text-muted">(alias)</span></div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-try"></i></div><div class="hidden-xs">fa-try</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-turkish-lira"></i></div><div class="hidden-xs">fa-turkish-lira <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-usd"></i></div><div class="hidden-xs">fa-usd</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-won"></i></div><div class="hidden-xs">fa-won <span class="text-muted">(alias)</span></div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-yen"></i></div><div class="hidden-xs">fa-yen <span class="text-muted">(alias)</span></div></td>
                                     <td></td>
                                     <td></td>
                                     <td></td>
                                 </tr>
                 ...
                 <div class="panel panel-inverse" data-sortable-id="ui-icons-14">
                     ...
                     <div class="panel-body">
                         <div class="table-responsive">
                             <table class="table table-bordered m-b-0">
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-double-down"></i></div><div class="hidden-xs">fa-angle-double-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-double-left"></i></div><div class="hidden-xs">fa-angle-double-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-double-right"></i></div><div class="hidden-xs">fa-angle-double-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-double-up"></i></div><div class="hidden-xs">fa-angle-double-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-down"></i></div><div class="hidden-xs">fa-angle-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-left"></i></div><div class="hidden-xs">fa-angle-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-right"></i></div><div class="hidden-xs">fa-angle-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-angle-up"></i></div><div class="hidden-xs">fa-angle-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-down"></i></div><div class="hidden-xs">fa-arrow-circle-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-left"></i></div><div class="hidden-xs">fa-arrow-circle-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-o-down"></i></div><div class="hidden-xs">fa-arrow-circle-o-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-o-left"></i></div><div class="hidden-xs">fa-arrow-circle-o-left</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-o-right"></i></div><div class="hidden-xs">fa-arrow-circle-o-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-o-up"></i></div><div class="hidden-xs">fa-arrow-circle-o-up</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-right"></i></div><div class="hidden-xs">fa-arrow-circle-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-circle-up"></i></div><div class="hidden-xs">fa-arrow-circle-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-down"></i></div><div class="hidden-xs">fa-arrow-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-left"></i></div><div class="hidden-xs">fa-arrow-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-right"></i></div><div class="hidden-xs">fa-arrow-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrow-up"></i></div><div class="hidden-xs">fa-arrow-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrows"></i></div><div class="hidden-xs">fa-arrows</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-arrows-alt"></i></div><div class="hidden-xs">fa-arrows-alt</div></td>
                                 ...
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-down"></i></div><div class="hidden-xs">fa-caret-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-left"></i></div><div class="hidden-xs">fa-caret-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-right"></i></div><div class="hidden-xs">fa-caret-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-square-o-down"></i></div><div class="hidden-xs">fa-caret-square-o-down</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-square-o-left"></i></div><div class="hidden-xs">fa-caret-square-o-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-square-o-right"></i></div><div class="hidden-xs">fa-caret-square-o-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-square-o-up"></i></div><div class="hidden-xs">fa-caret-square-o-up</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-caret-up"></i></div><div class="hidden-xs">fa-caret-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-circle-down"></i></div><div class="hidden-xs">fa-chevron-circle-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-circle-left"></i></div><div class="hidden-xs">fa-chevron-circle-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-circle-right"></i></div><div class="hidden-xs">fa-chevron-circle-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-circle-up"></i></div><div class="hidden-xs">fa-chevron-circle-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-down"></i></div><div class="hidden-xs">fa-chevron-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-left"></i></div><div class="hidden-xs">fa-chevron-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-right"></i></div><div class="hidden-xs">fa-chevron-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-chevron-up"></i></div><div class="hidden-xs">fa-chevron-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-hand-o-down"></i></div><div class="hidden-xs">fa-hand-o-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-hand-o-left"></i></div><div class="hidden-xs">fa-hand-o-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-hand-o-right"></i></div><div class="hidden-xs">fa-hand-o-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-hand-o-up"></i></div><div class="hidden-xs">fa-hand-o-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-long-arrow-down"></i></div><div class="hidden-xs">fa-long-arrow-down</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-long-arrow-left"></i></div><div class="hidden-xs">fa-long-arrow-left</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-long-arrow-right"></i></div><div class="hidden-xs">fa-long-arrow-right</div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-long-arrow-up"></i></div><div class="hidden-xs">fa-long-arrow-up</div></td>
                                 </tr>
                                 <tr>
                                     <td class="text-center"><div><i class="fa fa-2x fa-toggle-down"></i></div><div class="hidden-xs">fa-toggle-down <span class="text-muted">(alias)</span></div></td>
                                     <td class="text-center"><div><i class="fa fa-2x fa-toggle-left"></i></div><div class="hidden-xs">fa-toggle-left <span class="text-muted">(alias)</span></div></td>
