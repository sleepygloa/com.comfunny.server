...
//	var proCd = $('a[class="active"]').data('procd');
    ...
    const proNm = 'sdStore';
    const apiUrl = '/api/wms/sd/store';

    // [El]프로그램 그리드
    const $HGrid = $("#sdStoreHGrid");
    ...
    return {
        init: function () {
            gridUseYn	 		= WMSUtil.fnCombo.grid_selectBox('sdStoreUseYn', 'YN');
    ...
    function fnEvents(){
        ...
        //조회 버튼
        $("#sdStoreSearchBtn").click(function(){
            fnSearch();
        });

        //행 추가
        $("#sdStoreAddBtn").click(function(){
            $HGrid.paragonGridAddRow();
        });

        //저장 버튼
        $("#sdStoreSaveBtn").click(function(){
            fnSave();
        });

        //행 삭제 버튼
        $("#sdStoreDelBtn").click(function(){
            fnDel();
        });

        //엑셀 다운로드
        $("#sdStoreExcelBtn").click(function(){
    ...
    function fnSearch(){
        $HGrid.paragonGridSearch({
            storeNm : $('#sdStoreDcCd').val(),
            useYn : $('#sdStoreUseYn').val()
        });
    }
...
//			multielonly:true,
            ...
            colModel		: [
                ...
                {editable: true,name:'STORE_CD', 		width:"100px", align:"center", disabled:true, excel:true,
                    required:true,
                ...
                {editable: true,name:'STORE_NM', 		width:"200px", required:true, excel:true,
                ...
                {editable: true,name:'DELIVERY_DC_CD',  width:"100px",align:"center"},
                {editable: true,name:'DELIVERY_DOMAIN_CD',  width:"100px",align:"center"},
                {editable: true,name:'ALLOC_PRIOORD_CD',  width:"100px",align:"center"},
                {editable: true,name:'CHANNEL_GBN_CD',  width:"100px",align:"center"},
    ...
    function fnSave() {
        ...
        var rowData = {
            ...
            dealStartYmd    :"DEAL_START_YMD",
            dealEndYmd      :"DEAL_END_YMD",
            dealGbnCd       :"DEAL_GBN_CD",
            deliveryDcCd    :"DELIVERY_DC_CD",
            deliveryDomainCd:"DELIVERY_DOMAIN_CD",
            allocPrioordCd  :"ALLOC_PRIOORD_CD",
            channelGbnCd    :"CHANNEL_GBN_CD",
            useYn			:"USE_YN",
            remark			:"REMARK"
        }
    ...
    function fnDel() {
        ...
        var saveUrl = apiUrl+'/deleteStore';
    ...
    function fnValidate(){
        ...
        for(var i = 0; i < idx.length; i++){
            ...
            if(!(rowdata.STORE_CD)){
                ...
                return false;
            }else if(rowdata.STORE_CD.trim().length == 0 ){
            ...
            if(rowdata.STORE_NM.trim().length == 0 ){
