...
var FormPlugins = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $.getScript('/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js').done(function() {
                handleDatepicker();
            });
            
            $.getScript('/plugins/ionRangeSlider/js/ion-rangeSlider/ion.rangeSlider.min.js').done(function() {
			    handleIonRangeSlider();
            });
            
            $.getScript('/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js').done(function() {
			    handleFormColorPicker();
			});
			
            $.getScript('/plugins/masked-input/masked-input.min.js').done(function() {
			    handleFormMaskedInput();
			});
			
            $.getScript('/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js').done(function() {
			    handleFormTimePicker();
            });
            
            $.getScript('/plugins/password-indicator/js/password-indicator.js').done(function() {
			    handleFormPasswordIndicator();
            });
            
            $.getScript('/plugins/bootstrap-combobox/js/bootstrap-combobox.js').done(function() {
			    handleBootstrapCombobox();
            });
            
            $.getScript('/plugins/bootstrap-select/bootstrap-select.min.js').done(function() {
			    handleSelectpicker();
            });
            
            $.getScript('/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js').done(function() {
			    handleTagsInput();
            });
            
            $.getScript('/plugins/bootstrap-tagsinput/bootstrap-tagsinput-typeahead.js').done(function() {
			    handleJqueryAutocomplete();
            });
            
            $.getScript('/plugins/jquery-tag-it/js/tag-it.min.js').done(function() {
			    handleJqueryTagIt();
            });
            
            $.getScript('/plugins/bootstrap-daterangepicker/moment.js').done(function() {
                $.getScript('/plugins/bootstrap-daterangepicker/daterangepicker.js').done(function() {
                    handleDateRangePicker();
                });
            });
            
            $.getScript('/plugins/select2/dist/js/select2.min.js').done(function() {
                handleSelect2();
            });
        }
    };
