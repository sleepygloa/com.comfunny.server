...
!function( $ ) {
  ...
  * ================================ */
  ...
  var Combobox = function ( element, options ) {
    ...
    this.listen();
    this.$element.attr("id",this.$source.attr("id")+"_input");
  };
  ...
  , parse: function () {
      ...
      if (selected) {
        ...
        if(this.options.nonReset){
        	this.$element.removeClass("non-selected");
        }
        this.$target.val(selectedValue);
        this.$container.addClass('combobox-selected');
        this.selected = true;
      }
      this.$element.attr("placeholder",that.options.placeholder);
      return source;
    }
  ...
  , blur: function (e) {
      ...
      if (!this.selected && val !== '' ) {
	    if(this.options.nonReset){
			this.$element.addClass("non-selected");
	    }else{
	    	this.$element.val('');
	    }
