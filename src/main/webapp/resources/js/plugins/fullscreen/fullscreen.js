! function(a) {
    ...
    function e(b) {
        return function(c, d) {
            ...
            return b !== j.exit || a[f.element] ? (a.addEventListener(f.events.change, e, !1), void a.addEventListener(f.events.error, g, !1)) :
            	void a.addEventListener(f.events.error, g, !1)
        }
    }
    var f, g, h = !0,
        i = {
    ...
    for (g in i)
        ...
        var b = a[f.exit]();
        return !b && window.Promise ? new Promise(e(j.exit)) : b
    }, Element.prototype[j.request] = function() {
        var a = this[f.request].apply(this, arguments);
        return !a && window.Promise ? new Promise(e(j.request)) : a
    }), f
}(document);