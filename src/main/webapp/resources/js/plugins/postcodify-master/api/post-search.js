...
(function($) {
    ...
    $.fn.postcodify = function(options) {
        ...
        return this.each(function() {
            ...
            var etTitle = $('<span class="et-tit first">검색 키워드</span>').appendTo(controls);
            ...
            var searchButton = $('<button type="button" class="white search post"><i>검색</i></button>').attr("id", uniqueId + "_button").html(settings.searchButtonContent).appendTo(controls);
